...
import org.bitcoincashj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of bitcoincashj fixes the known
     ...
     * {@link org.bitcoincashj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.bitcoincashj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.bitcoincashj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.bitcoincashj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.bitcoincashj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.bitcoincashj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.bitcoincashj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.bitcoincashj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.bitcoincashj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a bitcoincashj based app running in SPV mode to fully validating security.
     */
