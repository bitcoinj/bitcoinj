...
/**
 * <p>A KeyChainGroup is used by the {@link org.monacoinj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.monacoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.monacoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.monacoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
