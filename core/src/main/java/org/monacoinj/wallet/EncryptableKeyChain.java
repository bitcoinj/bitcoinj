...
import org.monacoinj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.monacoinj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.monacoinj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.monacoinj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
