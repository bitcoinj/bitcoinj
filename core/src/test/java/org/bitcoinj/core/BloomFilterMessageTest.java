...
public class BloomFilterMessageTest {
    private static final NetworkParameters MAINNET = MainNetParams.get();

    @Test
    public void insertSerializeTest() {
        BloomFilter bloomFilter = new BloomFilter(3, 0.01, 0, BloomFilter.BloomUpdate.UPDATE_ALL);
        bloomFilter.insert(ByteUtils.parseHex("99108ad8ed9bb6274d3980bab5a85c048f0950c8"));
        bloomFilter.insert(ByteUtils.parseHex("b5a2c786d9ef4658287ced5914b37a1b4aa32eee"));
        bloomFilter.insert(ByteUtils.parseHex("b9300670b4c5366e95b2699e8b18bc75e5f729c5"));
        BloomFilterMessage message = new BloomFilterMessage(bloomFilter);

        // Value generated by Bitcoin Core
        assertEquals("03614e9b050000000000000001", ByteUtils.formatHex(message.serialize()));
    }
    
    @Test
    public void insertSerializeTestWithTweak() {
        BloomFilter bloomFilter = new BloomFilter(3, 0.01, 0x80000001);
        bloomFilter.insert(ByteUtils.parseHex("99108ad8ed9bb6274d3980bab5a85c048f0950c8"));
        bloomFilter.insert(ByteUtils.parseHex("b5a2c786d9ef4658287ced5914b37a1b4aa32eee"));
        bloomFilter.insert(ByteUtils.parseHex("b9300670b4c5366e95b2699e8b18bc75e5f729c5"));
        BloomFilterMessage message = new BloomFilterMessage(bloomFilter);
        ...
        // Value generated by Bitcoin Core
        assertEquals("03ce4299050000000100008002", ByteUtils.formatHex(message.serialize()));
    }
    ...
    public void walletTest() {
        ...
        BloomFilterMessage message = new BloomFilterMessage(wallet.getBloomFilter(wallet.getBloomFilterElementCount(), 0.001, 0));
        
        // Value generated by Bitcoin Core
        assertEquals("082ae5edc8e51d4a03080000000000000002", ByteUtils.formatHex(message.serialize()));
    }
}
