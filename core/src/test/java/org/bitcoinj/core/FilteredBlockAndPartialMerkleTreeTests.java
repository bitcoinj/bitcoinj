...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    public void deserializeFilteredBlock() throws Exception {
        ...
        // With one tx
        byte[] payload = HEX.decode("0100000079cda856b143d9db2c1caff01d1aecc8630d30625d10e8b4b8b0000000000000b50cc069d6a3e33e3ff84a5c41d9d3febe7c770fdcc96b2c3ff60abe184f196367291b4d4c86041b8fa45d630100000001b50cc069d6a3e33e3ff84a5c41d9d3febe7c770fdcc96b2c3ff60abe184f19630101");
        FilteredBlock block = new FilteredBlock(PARAMS, payload, 0, PARAMS.getDefaultSerializer(), payload.length);
        
        // Check that the header was properly deserialized
        assertTrue(block.getHash().equals(Sha256Hash.wrap("000000000000dab0130bbcc991d3d7ae6b81aa6f50a798888dfe62337458dc45")));
        ...
        payload = block.bitcoinSerialize();
        assertEquals(block, new FilteredBlock(PARAMS, payload, 0, PARAMS.getDefaultSerializer(), payload.length));
    }
    ...
    public void serializeDownloadBlockWithWallet() throws Exception {
        ...
        byte[] payload = HEX.decode("");
        FilteredBlock filteredBlock = new FilteredBlock(PARAMS, payload, 0, PARAMS.getDefaultSerializer(), payload.length);
        // Block 100001
