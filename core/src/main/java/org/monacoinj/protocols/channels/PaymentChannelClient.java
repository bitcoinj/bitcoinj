...
import org.monacoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class PaymentChannelClient implements IPaymentChannelClient {
        ...
        switch (majorVersion) {
            case 1:
                ...
                Protos.ProvideRefund.Builder provideRefundBuilder = Protos.ProvideRefund.newBuilder()
                        ...
                        .setTx(ByteString.copyFrom(((PaymentChannelV1ClientState)state).getIncompleteRefundTransaction().unsafeMonacoinSerialize()));
            ...
            case 2:
                ...
                Protos.ProvideContract.Builder provideContractBuilder = Protos.ProvideContract.newBuilder()
                        .setTx(ByteString.copyFrom(state.getContract().unsafeMonacoinSerialize()))
                ...
                try {
                    ...
                    initialMsg.setSignature(ByteString.copyFrom(payment.signature.encodeToMonacoin()));
     ...
     * {@link org.monacoinj.protocols.channels.IPaymentChannelClient.ClientConnection#destroyConnection(org.monacoinj.protocols.channels.PaymentChannelCloseException.CloseReason)} to settle the connection, it does not
    ...
    public ListenableFuture<PaymentIncrementAck> incrementPayment(Coin size, @Nullable ByteString info, @Nullable KeyParameter userKey)
        ...
        try {
            ...
            Protos.UpdatePayment.Builder updatePaymentBuilder = Protos.UpdatePayment.newBuilder()
                    .setSignature(ByteString.copyFrom(payment.signature.encodeToMonacoin()))
