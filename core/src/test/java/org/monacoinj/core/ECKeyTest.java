...
import org.monacoinj.core.ECKey.ECDSASignature;
import org.monacoinj.crypto.EncryptedData;
import org.monacoinj.crypto.KeyCrypter;
...
import org.monacoinj.wallet.Protos.ScryptParameters;
...
import static org.monacoinj.core.Utils.reverseBytes;
...
public class ECKeyTest {
    ...
    public void base58Encoding() throws Exception {
        ...
        ECKey key = DumpedPrivateKey.fromBase58(TestNet4Params.get(), privkey).getKey();
        assertEquals(privkey, key.getPrivateKeyEncoded(TestNet4Params.get()).toString());
        assertEquals(addr, key.toAddress(TestNet4Params.get()).toString());
    }
    ...
    public void base58Encoding_stress() throws Exception {
        ...
        for (int i = 0 ; i < 20 ; i++) {
            ECKey key = new ECKey();
            ECKey key1 = DumpedPrivateKey.fromBase58(TestNet4Params.get(),
                    key.getPrivateKeyEncoded(TestNet4Params.get()).toString()).getKey();
    ...
    public void verifyMessage() throws Exception {
        // Test vector generated by Monacoin-Qt.
    ...
    public void testCanonicalSigs() throws Exception {
        // Tests the canonical sigs from Monacoin Core unit tests
    ...
    public void testNonCanonicalSigs() throws Exception {
        // Tests the noncanonical sigs from Monacoin Core unit tests
