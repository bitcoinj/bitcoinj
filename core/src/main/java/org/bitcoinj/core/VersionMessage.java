...
public class VersionMessage extends Message {
    ...
    protected void parse() throws ProtocolException {
        ...
        receivingAddr = new PeerAddress(params, Payload.of(payload, cursor), this, serializer.withProtocolVersion(0));
        cursor += receivingAddr.getMessageSize();
        if (clientVersion >= 106) {
            fromAddr = new PeerAddress(params, Payload.of(payload, cursor), this, serializer.withProtocolVersion(0));
