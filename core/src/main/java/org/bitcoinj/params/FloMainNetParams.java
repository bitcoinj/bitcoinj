...
public class FloMainNetParams extends AbstractBitcoinNetParams {
    ...
    private static FloMainNetParams instance;
    public static synchronized FloMainNetParams get() {
        if (instance == null) {
            instance = new FloMainNetParams();
        }
        return instance;
    }
