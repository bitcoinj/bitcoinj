...
public class KeyChainGroupTest {
    ...
    public void bloom() {
        ...
        BloomFilter filter = group.getBloomFilter(group.getBloomFilterElementCount(), 0.001, Integer.toUnsignedLong(new Random().nextInt()));
        ...
        filter = group.getBloomFilter(group.getBloomFilterElementCount(), 0.001, Integer.toUnsignedLong(new Random().nextInt()));
        assertTrue(filter.contains(key1.getPubKeyHash()));
        assertTrue(filter.contains(key1.getPubKey()));
    ...
    public void bloomFilterForMarriedChains() {
        ...
        assertEquals(expected, group.getBloomFilterElementCount());
        BloomFilter filter = group.getBloomFilter(expected + 2, 0.001, Integer.toUnsignedLong(new Random().nextInt()));
