...
public final class BlockLocator {
    ...
    public BlockLocator() {
        hashes = Collections.unmodifiableList(new LinkedList<Sha256Hash>());
    }
     ...
     */
    public BlockLocator add(final Sha256Hash hash) {
        return new BlockLocator(new LinkedList<Sha256Hash>(){{
            addAll(hashes);
            add(hash);
        }});
    }
