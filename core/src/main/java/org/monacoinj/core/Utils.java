...
/**
 * A collection of various utility methods that are helpful for working with the Monacoin protocol.
 * To enable debug logging from the library, run with -Dmonacoinj.logging=true on your command line.
 */
public class Utils {
     ...
     *
     * <p>Monacoin only uses this "compact" format for encoding difficulty targets, which are unsigned 256bit quantities.
     ...
     *
     * <tt><p>[24] "Monacoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
