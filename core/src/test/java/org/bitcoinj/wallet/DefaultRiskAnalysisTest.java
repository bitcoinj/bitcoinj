...
public class DefaultRiskAnalysisTest {
    ...
    public void nonShortestPossiblePushData() {
        ...
        tx.addInput(new TransactionInput(null, nonStandardScript, TransactionOutPoint.ConnectedTransactionOutPoint.UNCONNECTED));
    ...
    public void canonicalSignature() {
        ...
        assertEquals(RuleViolation.NONE,
                DefaultRiskAnalysis.isInputStandard(new TransactionInput(null, scriptOk.getProgram(), TransactionOutPoint.ConnectedTransactionOutPoint.UNCONNECTED)));
        ...
        assertEquals(RuleViolation.SIGNATURE_CANONICAL_ENCODING, DefaultRiskAnalysis.isInputStandard(
                new TransactionInput(null, scriptUncanonicalEncoding.getProgram(), TransactionOutPoint.ConnectedTransactionOutPoint.UNCONNECTED)));
    }
    ...
    public void canonicalSignatureLowS() throws Exception {
        ...
        assertEquals(RuleViolation.SIGNATURE_CANONICAL_ENCODING, DefaultRiskAnalysis.isInputStandard(
                new TransactionInput(null, scriptHighS.getProgram(), TransactionOutPoint.ConnectedTransactionOutPoint.UNCONNECTED)));
        ...
        Transaction tx2 = new Transaction(ByteBuffer.wrap(ByteUtils.parseHex(
