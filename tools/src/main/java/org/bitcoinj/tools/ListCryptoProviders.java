...
public class ListCryptoProviders {
    ...
    static void  printEcdsaProviders() {
        ...
        for (Provider p : candidates) {
            ...
            boolean byOid  = ecdsaWorks(p, ECDSA_OID);
    ...
    /**
     * Install Bouncy Castle if it exists on the classpath.
     * @return true if Bouncy Castle was installed, false otherwise.
     */
    ...
    /**
     * Check whether a given provider can sign/verify on a curve.
     * @param p provider instance
     * @param curveName name of curve to test
     * @return true if sign and verify seem to work correctly, false otherwise.
     */
    ...
    /**
     * Shorten the provider info string for common types with verbose info strings.
     * @param info An info string to potentially shorten
     * @return the processed (and possibly shortened) info string
     */
