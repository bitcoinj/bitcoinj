 ...
 * {@link org.bitcoincashj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.bitcoincashj.crypto.MnemonicCode},
 ...
 * {@link org.bitcoincashj.crypto.DeterministicKey#serializePubB58(org.bitcoincashj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.bitcoincashj.crypto.DeterministicKey#deserializeB58(org.bitcoincashj.crypto.DeterministicKey, String, org.bitcoincashj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.bitcoincashj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.bitcoincashj.crypto.DeterministicHierarchy} and
 * {@link org.bitcoincashj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from bitcoincashj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.bitcoincashj.crypto.DeterministicKey)}
     ...
     * @see org.bitcoincashj.wallet.MarriedKeyChain
     */
