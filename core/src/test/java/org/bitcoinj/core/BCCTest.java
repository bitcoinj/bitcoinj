...
public class BCCTest {
    ...
    public void testP2SHMultiSign() {
        ...
        // TODO: This will fail. org.bitcoinj.script.Script.executeMultiSig() should be updated
    ...
    public void testP2PKHSign() {
        ...
        // TODO: This will fail. org.bitcoinj.script.Script.executeCheckSig() should be updated
//         tx.getInput(0).verify(output);
    }
}
