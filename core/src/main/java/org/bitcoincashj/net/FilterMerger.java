...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.bitcoincashj.core.PeerFilterProvider}s, a merged
 * {@link org.bitcoincashj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.bitcoincashj.core.PeerGroup} class internally.</p>
 *
