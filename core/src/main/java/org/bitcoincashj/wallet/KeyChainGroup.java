...
/**
 * <p>A KeyChainGroup is used by the {@link org.bitcoincashj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.bitcoincashj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.bitcoincashj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.bitcoincashj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
