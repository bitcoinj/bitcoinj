...
public class PaymentChannelServer {
        ...
        Futures.addCallback(result, new FutureCallback<Transaction>() {
            ...
            public void onSuccess(Transaction result) {
                ...
                if (result != null) {
                    ...
                    // properly and so on.
                    msg.getSettlementBuilder().setTx(ByteString.copyFrom(result.unsafeMonacoinSerialize()));
     ...
     * {@link org.monacoinj.protocols.channels.PaymentChannelServer.ServerConnection#destroyConnection(org.monacoinj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link org.monacoinj.protocols.channels.PaymentChannelServer.ServerConnection#destroyConnection(org.monacoinj.protocols.channels.PaymentChannelCloseException.CloseReason)}. Note that this does not broadcast
