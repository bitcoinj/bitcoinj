...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    public void deserializeFilteredBlock() throws Exception {
        ...
        assertEquals(block, new FilteredBlock(PARAMS, block.monacoinSerialize()));
    }
    ...
    public void serializeDownloadBlockWithWallet() throws Exception {
        ...
        // Note that all serialized forms here are generated by Monacoin Core/pulled from block explorer
        ...
        assertArrayEquals(HEX.decode("0e1b091ca195e45a9164889b6bc46a09000000efbeadde02"), filter.unsafeMonacoinSerialize());
