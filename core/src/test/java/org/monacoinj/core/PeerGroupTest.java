...
public class PeerGroupTest extends TestWithPeerGroup {
    ...
    public void noPings() throws Exception {
        ...
        versionMessage.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getMonacoinProtocolVersion();
    ...
    public void downloadPeerSelection() throws Exception {
        ...
        versionMessage2.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getMonacoinProtocolVersion();
        versionMessage2.localServices = VersionMessage.NODE_NETWORK;
        VersionMessage versionMessage3 = new VersionMessage(PARAMS, 3);
        versionMessage3.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getMonacoinProtocolVersion();
    ...
    public void testBloomOnP2Pubkey() throws Exception {
        ...
        assertTrue(p3.lastReceivedFilter.contains(outpoint.unsafeMonacoinSerialize()));
    }
    ...
    public void preferLocalPeer() throws IOException {
        // Because we are using the same port (8333 or 18333) that is used by Monacoin Core
    ...
    public void autoRescanOnKeyExhaustion() throws Exception {
        ...
        BloomFilter filter = new BloomFilter(PARAMS, p1.lastReceivedFilter.monacoinSerialize());
