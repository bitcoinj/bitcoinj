...
import org.monacoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties;
 ...
 * <i>receiving party</i>. Although the underlying Monacoin protocol is capable of more complex relationships than that,
 ...
 *
 * <p>To begin, the client calls {@link PaymentChannelClientState#initiate(KeyParameter, org.monacoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties)}, which moves the channel into state
...
public abstract class PaymentChannelClientState {
     ...
     * {@link PaymentChannelClientState#initiate(KeyParameter, org.monacoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties)} after construction (to avoid creating objects for channels which are
     * not going to finish opening) and thus some parameters provided here are only used in
     * {@link PaymentChannelClientState#initiate(KeyParameter, org.monacoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties)} to create the Multisig contract and refund transaction.
     *
     ...
     * the channel properly. May only be called after {@link PaymentChannelClientState#initiate(KeyParameter, org.monacoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties)}
     */
