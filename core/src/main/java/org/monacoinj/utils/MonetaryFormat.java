...
import org.monacoinj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /** Standard format for the MONA denomination. */
    public static final MonetaryFormat MONA = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mMONA denomination. */
    public static final MonetaryFormat MMONA = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µMONA denomination. */
    public static final MonetaryFormat UMONA = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Currency code for base 1 Monacoin. */
    public static final String CODE_MONA = "MONA";
    /** Currency code for base 1/1000 Monacoin. */
    public static final String CODE_MMONA = "mMONA";
    /** Currency code for base 1/1000000 Monacoin. */
    public static final String CODE_UMONA = "µMONA";
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for Monacoin
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard MONA notation that was
    ...
    public MonetaryFormat() {
        ...
        this.codes[0] = CODE_MONA;
        this.codes[3] = CODE_MMONA;
        this.codes[6] = CODE_UMONA;
        this.codeSeparator = ' ';
    ...
    /**
     * Parse a human readable coin value to a {@link org.monacoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.monacoinj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
