...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * the FP rate higher, due to <a href="https://groups.google.com/forum/#!msg/monacoinj/Ys13qkTwcNg/9qxnhwnkeoIJ">
     * various complexities</a> there are still ways a remote peer can deanonymize the users wallet. This is why the
     * FP rate is chosen for performance rather than privacy. If a future version of monacoinj fixes the known
     ...
     * <a href="https://github.com/monacoin/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     *
     ...
     * {@link org.monacoinj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.monacoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.monacoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.monacoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.monacoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.monacoinj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.monacoinj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.monacoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.monacoinj.core.Peer#ping()}.
     */
    ...
    /**
     * When true (the default), PeerGroup will attempt to connect to a Monacoin node running on localhost before
     * attempting to use the P2P network. If successful, only localhost will be used. This makes for a simple
     * and easy way for a user to upgrade a monacoinj based app running in SPV mode to fully validating security.
     */
