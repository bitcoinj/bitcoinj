 ...
 * <p>When downloading from localhost, run monacoind locally: monacoind -testnet -daemon.
 * After monacoind is up and running, use command: org.monacoinj.examples.FetchBlock --localhost &lt;blockHash&gt; </p>
 * <p>Otherwise, use command: org.monacoinj.examples.FetchBlock &lt;blockHash&gt;, this command will download blocks from a peer generated by DNS seeds.</p>
 */
public class FetchBlock {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (opts.has("help")) {
                System.out.println("usage: org.monacoinj.examples.FetchBlock [--localhost] <blockHash>");
            ...
            System.err.println("usage: org.monacoinj.examples.FetchBlock [--localhost] <blockHash>");
