/*
 * Copyright 2012 The Monacoin Developers
...
public class PartialMerkleTree extends Message {
    ...
    @Override
    public void monacoinSerializeToStream(OutputStream stream) throws IOException {
    ...
    // Based on CPartialMerkleTree::TraverseAndBuild in Monacoin Core.
