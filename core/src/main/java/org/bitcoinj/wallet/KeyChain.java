...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a #$Wallet. Key chains
 ...
 * that you to use a method of a specific key chain instance, such as #$BasicKeyChain. The reason for these
