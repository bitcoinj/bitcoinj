...
public class KeyChainGroupTest {
    ...
    public void createDeterministic_P2WPKH() {
        ...
        address = kcg.freshAddress(KeyPurpose.RECEIVE_FUNDS, ScriptType.P2PKH, Optional.empty());
        assertEquals(ScriptType.P2PKH, address.getOutputScriptType());
    }
    ...
    public void deterministicUpgradeRequired() {
        ...
        assertTrue(group.isDeterministicUpgradeRequired(ScriptType.P2PKH, Optional.empty()));
        assertTrue(group.isDeterministicUpgradeRequired(ScriptType.P2WPKH, Optional.empty()));
    ...
    public void deterministicUpgradeUnencrypted() throws Exception {
        ...
        group.upgradeToDeterministic(ScriptType.P2PKH, KeyChainGroupStructure.BIP32, Optional.empty(), null);
        assertFalse(group.isEncrypted());
        assertFalse(group.isDeterministicUpgradeRequired(ScriptType.P2PKH, Optional.empty()));
        assertTrue(group.isDeterministicUpgradeRequired(ScriptType.P2WPKH, Optional.empty()));
        ...
        group.upgradeToDeterministic(ScriptType.P2PKH, KeyChainGroupStructure.BIP32, Optional.empty(), null);  // Should give same result as last time.
        assertFalse(group.isEncrypted());
        assertFalse(group.isDeterministicUpgradeRequired(ScriptType.P2PKH, Optional.empty()));
        assertTrue(group.isDeterministicUpgradeRequired(ScriptType.P2WPKH, Optional.empty()));
