...
import org.monacoinj.net.AbstractTimeoutHandler;
import org.monacoinj.net.MessageWriteTarget;
 ...
 * {@link org.monacoinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
    ...
    private MonacoinSerializer.MonacoinPacketHeader header;
    ...
    public int receiveBytes(ByteBuffer buff) {
        checkArgument(buff.position() == 0 &&
                buff.capacity() >= MonacoinSerializer.MonacoinPacketHeader.HEADER_LENGTH + 4);
        try {
     ...
     * called automatically by {@link org.monacoinj.net.NioClient} or
     * {@link org.monacoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
