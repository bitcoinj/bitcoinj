...
public class WalletProtobufSerializerTest {
    ...
    public void testLastBlockSeenHash() throws Exception {
        ...
        Block block = TESTNET.getDefaultSerializer()
                .makeBlock(Payload.of(ByteStreams.toByteArray(BlockTest.class.getResourceAsStream("block_testnet700000.dat"))));
    ...
    public void roundtripVersionTwoTransaction() throws Exception {
        Transaction tx = new Transaction(TESTNET, Payload.ofHex(
