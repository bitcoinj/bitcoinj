 ...
 *
 * <p>When formatting Monacoin monetary values, an instance of this class automatically adjusts
 ...
 *
 * <p>When parsing <code>String</code> representations of Monacoin monetary values, instances of
...
public final class BtcAutoFormat extends BtcFormat {
    ...
    public enum Style {
        ...
        /** Constant for the formatting style that uses a currency code, e.g., "MONA". */
        CODE {
    ...
    /**
     * Calculate the appropriate denomination for the given Monacoin monetary value.  This
