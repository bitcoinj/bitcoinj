...
public class SendHeadersMessageTest {
    ...
    public void decodeAndEncode() throws Exception {
        ...
        RegTestParams params = org.monacoinj.params.RegTestParams.get();
        MonacoinSerializer serializer = new MonacoinSerializer(params, false);
        assertTrue(serializer.deserialize(buffer) instanceof org.monacoinj.core.SendHeadersMessage);
    }
}
