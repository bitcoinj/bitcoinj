...
public class AddressV2Message extends AddressMessage {
     ...
     */
    AddressV2Message(NetworkParameters params, Payload payload, MessageSerializer serializer, int length) throws ProtocolException {
        super(params, payload, serializer, length);
    }

    AddressV2Message(NetworkParameters params, Payload payload) throws ProtocolException {
