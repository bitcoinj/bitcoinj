...
public class BitcoinNetworkTest {
    ...
    public void testLegacyAddressValidity() {
        ...
        assertTrue(MAINNET.isValidAddress(m) &&
                TESTNET.isValidAddress(t) &&
                SIGNET.isValidAddress(t) &&
                REGTEST.isValidAddress(t));
        assertFalse(MAINNET.isValidAddress(t) &&
                TESTNET.isValidAddress(m) &&
                SIGNET.isValidAddress(m) &&
                REGTEST.isValidAddress(m));
    }
    ...
    public void testSegwitAddressValidity() {
        ...
        assertTrue(MAINNET.isValidAddress(m) &&
                TESTNET.isValidAddress(t) &&
                SIGNET.isValidAddress(t) &&
                REGTEST.isValidAddress(rt));
        assertFalse(MAINNET.isValidAddress(t) &&
                MAINNET.isValidAddress(rt) &&
                TESTNET.isValidAddress(m) &&
                TESTNET.isValidAddress(rt) &&
                SIGNET.isValidAddress(m) &&
                SIGNET.isValidAddress(rt) &&
                REGTEST.isValidAddress(m) &&
                REGTEST.isValidAddress(t));
    }
