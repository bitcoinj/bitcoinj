...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link WalletIF}. Key chains
 ...
 * keys, for instance you need an implementor of {@link org.bitcoinj.wallet.EncryptableKeyChain}. It cannot have keys imported into it,
 * that you to use a method of a specific key chain instance, such as {@link org.bitcoinj.wallet.BasicKeyChain}. The reason for these
