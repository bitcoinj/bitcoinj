...
public class StandardDifficultyTransitionsTest {
    ...
    public void isDifficultyTransitionPoint() {
        assertFalse(TRANSITIONS.isDifficultyTransitionPoint(2014));
        assertTrue(TRANSITIONS.isDifficultyTransitionPoint(2015));
        assertFalse(TRANSITIONS.isDifficultyTransitionPoint(2016));
    }
}
