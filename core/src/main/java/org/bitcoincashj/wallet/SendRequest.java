...
import org.bitcoincash.protocols.payments.Protos.PaymentDetails;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.bitcoincashj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.bitcoincashj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
