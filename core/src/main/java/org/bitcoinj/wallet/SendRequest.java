...
public class SendRequest {
    ...
    public String toString() {
        return new ToStringUtil(this)
                ...
                .addIf(changeAddress != null, "changeAddress", changeAddress)
                .addIf(feePerKb != null, "feePerKb", feePerKb)
                .add("ensureMinRequiredFee", ensureMinRequiredFee)
                .add("signInputs", signInputs)
                .addIf(aesKey != null, "aesKey", "set") // careful to not leak the key
                .addIf(coinSelector != null, "coinSelector", coinSelector)
