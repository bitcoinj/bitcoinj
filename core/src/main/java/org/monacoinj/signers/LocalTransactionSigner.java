...
/**
 * <p>{@link TransactionSigner} implementation for signing inputs using keys from provided {@link org.monacoinj.wallet.KeyBag}.</p>
 ...
 * {@link org.monacoinj.signers.TransactionSigner.ProposedTransaction} object that will be also passed then to the next signer in chain. This allows other
 ...
 * <p>This signer always uses {@link org.monacoinj.core.Transaction.SigHash#ALL} signing mode.</p>
 */
    ...
    public boolean signInputs(ProposedTransaction propTx, KeyBag keyBag) {
        ...
        for (int i = 0; i < numInputs; i++) {
            ...
            try {
                ...
                int sigIndex = 0;
                inputScript = scriptPubKey.getScriptSigWithSignature(inputScript, signature.encodeToMonacoin(), sigIndex);
