 ...
 * the lightweight SPV mode, a {@link org.monacoinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.monacoinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
 * Monacoin Core. To learn more about the alternative security models, please consult the articles on the
 * website.</p>
 *
 * <b>Theory</b>
 *
...
public abstract class AbstractBlockChain {
     ...
     *
     * Following this one down to the genesis block produces the story of the economy from the creation of Monacoin
    ...
    private static void sendTransactionsToListener(StoredBlock block, NewBlockType blockType,
        ...
        for (Transaction tx : transactions) {
            try {
                ...
                if (clone)
                    tx = tx.params.getDefaultSerializer().makeTransaction(tx.monacoinSerialize());
