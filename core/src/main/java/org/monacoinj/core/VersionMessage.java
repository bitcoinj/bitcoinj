...
public class VersionMessage extends Message {
    ...
    public VersionMessage(NetworkParameters params, int newBestHeight) {
        ...
        // Note that the Monacoin Core doesn't do anything with these, and finding out your own external IP address
    ...
    @Override
    public void monacoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.monacoinSerialize(buf);
            // Their address.
            theirAddr.monacoinSerialize(buf);
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for monacoinj
     * users might look like "/monacoinj:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
