...
// This file shows how to use litecoinj from Javascript.
// To run, grab the litecoinj bundled JAR and then do something like this:
//
//   jjs -cp litecoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp litecoinj-0.12-bundled.jar
//
...
//
//   jjs -cp litecoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And litecoinj is a threaded library. This means you
