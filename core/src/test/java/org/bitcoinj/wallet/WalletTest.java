...
public class WalletTest extends TestWithWallet {
    ...
    public void balanceWithIdenticalOutputs() {
        ...
        Transaction tx = new Transaction(BitcoinNetwork.TESTNET);
    ...
    public void bounce() throws Exception {
        ...
        Transaction inbound2 = new Transaction(BitcoinNetwork.TESTNET);
    ...
    public void doubleSpendWeReceive() {
        ...
        Transaction t1b = new Transaction(BitcoinNetwork.TESTNET);
    ...
    public void pending3() {
        ...
        Transaction doubleSpentTx = new Transaction(BitcoinNetwork.TESTNET);
    ...
    public void watchingScriptsSentFrom() {
        ...
        Transaction st2 = new Transaction(BitcoinNetwork.TESTNET);
    ...
    public void outOfOrderPendingTxns() {
        ...
        Transaction b = new Transaction(BitcoinNetwork.TESTNET);
    ...
    public void feeSolverAndCoinSelectionTests2() throws Exception {
        ...
        Transaction spendTx5 = new Transaction(BitcoinNetwork.TESTNET);
    ...
    public void testIrrelevantDoubleSpend() throws Exception {
        ...
        Transaction tx3 = new Transaction(BitcoinNetwork.TESTNET);
        ...
        Transaction tx4 = new Transaction(BitcoinNetwork.TESTNET);
    ...
    public void overridingDeadTxTest() throws Exception {
        ...
        Transaction tx1 = new Transaction(BitcoinNetwork.TESTNET);
