 ...
 * Currently this includes getaddr, verack and special monacoinj class UnknownMessage.</p>
 * 
...
public abstract class EmptyMessage extends Message {
    ...
    @Override
    protected final void monacoinSerializeToStream(OutputStream stream) throws IOException {
    }
