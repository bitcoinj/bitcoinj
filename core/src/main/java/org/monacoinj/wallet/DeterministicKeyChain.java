 ...
 * <a href="https://github.com/monacoin/bips/blob/master/bip-0032.mediawiki">BIP 32 standard</a>, as implemented by
 * {@link org.monacoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.monacoinj.crypto.MnemonicCode},
 ...
 * {@link org.monacoinj.crypto.DeterministicKey#serializePubB58(org.monacoinj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.monacoinj.crypto.DeterministicKey#deserializeB58(org.monacoinj.crypto.DeterministicKey, String, org.monacoinj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.monacoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.monacoinj.crypto.DeterministicHierarchy} and
 * {@link org.monacoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     *  Using {@link org.monacoinj.crypto.KeyCrypter KeyCrypter} to decrypt.
     */
    protected DeterministicKeyChain(DeterministicSeed seed, @Nullable KeyCrypter crypter,
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from monacoinj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.monacoinj.crypto.DeterministicKey)}
            ...
            if (t == Protos.Key.Type.DETERMINISTIC_MNEMONIC) {
                ...
                if (!isWatchingAccountKey) {
                    ...
                    if (path.isEmpty()) {
                        ...
                        // (also known as change addresses). https://github.com/monacoin/bips/blob/master/bip-0044.mediawiki
     ...
     * @see org.monacoinj.wallet.MarriedKeyChain
     */
