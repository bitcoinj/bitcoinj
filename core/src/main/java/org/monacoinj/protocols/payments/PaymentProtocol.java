...
/**
 * <p>Utility methods and constants for working with <a href="https://github.com/monacoin/bips/blob/master/bip-0070.mediawiki">
 ...
 * protocol data does not flow over the Monacoin P2P network or enter the block chain. It's instead for data that is only
 * of interest to the parties involved but isn't otherwise needed for consensus.</p>
 */
public class PaymentProtocol {

    // MIME types as defined in BIP71.
    public static final String MIMETYPE_PAYMENTREQUEST = "application/monacoin-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/monacoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/monacoin-paymentack";

    /**
     * Create a payment request with one standard pay to address output. You may want to sign the request using
     * {@link #signPaymentRequest}. Use {@link org.monacoin.protocols.payments.Protos.PaymentRequest.Builder#build} to get the actual payment
     * request.
     *
     ...
     * {@link org.monacoin.protocols.payments.Protos.PaymentRequest.Builder#build} to get the actual payment request.
     * 
     * @param params network parameters
     ...
     * @return verification data, or null if no PKI method was specified in the {@link org.monacoin.protocols.payments.Protos.PaymentRequest}.
    ...
    public static Protos.Payment createPaymentMessage(List<Transaction> transactions,
        ...
        for (Transaction transaction : transactions) {
            transaction.verify();
            builder.addTransactions(ByteString.copyFrom(transaction.unsafeMonacoinSerialize()));
        }
