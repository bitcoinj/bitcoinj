 ...
 * <a href="http://www.monacoin.org/monacoin.pdf">the Monacoin technical paper</a> for
...
public class Block extends Message {
    ...
    static final long ALLOWED_TIME_DRIFT = 2 * 60 * 60; // Same value as Monacoin Core.

    /**
     * A constant shared by the entire network: how large in bytes a block is allowed to be. One day we may have to
     * upgrade everyone to change this, so Monacoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /**
     * Constructs a block object from the Monacoin wire format.
     * @deprecated Use {@link MonacoinSerializer#makeBlock(byte[])} instead.
     */
    @Deprecated
    ...
    /**
     * Construct a block object from the Monacoin wire format.
    ...
    /**
     * Construct a block object from the Monacoin wire format. Used in the case of a block
     * contained within another message (i.e. for AuxPoW header).
     *
     * @param params NetworkParameters object.
     * @param payloadBytes Monacoin protocol formatted byte array containing message content.
     * @param offset The location of the first payload byte within the array.
    ...
    /**
     * <p>A utility method that calculates how much new Monacoin would be created by the block at the given height.
     * The inflation of Monacoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link org.monacoinj.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
     ...
     * Useful for non-Monacoin chains where the block header may not be a fixed
     * size.
     */
    ...
    public int getOptimalEncodingMessageSize() {
        ...
        optimalEncodingMessageSize = monacoinSerialize().length;
        return optimalEncodingMessageSize;
    }
    ...
    public Block cloneAsHeader() {
        ...
        copyMonacoinHeaderTo(block);
        return block;
    }

    /** Copy the block without transactions into the provided empty block. */
    protected final void copyMonacoinHeaderTo(final Block block) {
        block.nonce = nonce;
    ...
    /** Returns the version of the block data structure as defined by the Monacoin protocol. */
     ...
     * {@link org.monacoinj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the Monacoin "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, Coin value, final int height) {
        ...
        coinbase.length = coinbase.unsafeMonacoinSerialize().length;
    ...
    /**
     * Create a block sending 50MONA as a coinbase transaction to the public key specified.
     ...
     * <a href="https://github.com/monacoin/bips/blob/master/bip-0034.mediawiki">BIP34: Height in Coinbase</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/monacoin/bips/blob/master/bip-0066.mediawiki">BIP66: Strict DER signatures</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/monacoin/bips/blob/master/bip-0065.mediawiki">BIP65: OP_CHECKLOCKTIMEVERIFY</a>.
     */
