...
public class BlockTest {
    ...
    public void testCoinbaseHeightTestnet() throws Exception {
        ...
        Block block = TESTNET.getDefaultSerializer().makeBlock(Payload.of(
        ...
        block = TESTNET.getDefaultSerializer().makeBlock(Payload.of(
    ...
    public void testReceiveCoinbaseTransaction() throws Exception {
        ...
        Block block169482 = MAINNET.getDefaultSerializer().makeBlock(Payload.of(
    ...
    public void testBlock481815_witnessCommitmentInCoinbase() throws Exception {
        Block block481815 = MAINNET.getDefaultSerializer().makeBlock(Payload.of(
    ...
    public void testBlock481829_witnessTransactions() throws Exception {
        Block block481829 = MAINNET.getDefaultSerializer().makeBlock(Payload.of(
    ...
    public void isBIPs() throws Exception {
        ...
        final Block block227835 = MAINNET.getDefaultSerializer().makeBlock(Payload.of(
        ...
        final Block block227836 = MAINNET.getDefaultSerializer().makeBlock(Payload.of(
        ...
        final Block block363703 = MAINNET.getDefaultSerializer().makeBlock(Payload.of(
        ...
        final Block block383616 = MAINNET.getDefaultSerializer().makeBlock(Payload.of(
        ...
        final Block block370661 = MAINNET.getDefaultSerializer().makeBlock(Payload.of(
