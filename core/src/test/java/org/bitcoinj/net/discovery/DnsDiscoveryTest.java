...
public class DnsDiscoveryTest {
    ...
    public void testBuildDiscoveries() throws PeerDiscoveryException {
        String[] seeds = new String[]{"seed.bitcoin.sipa.be", "dnsseed.bluematt.me", "dnsseed.bitcoin.dashjr.org"};
        DnsDiscovery dnsDiscovery = new DnsDiscovery(seeds, MainNetParams.get());
        assertTrue(dnsDiscovery.seeds.size() == 3);
    ...
    public void testGetPeersReturnsNotEmptyListOfSocketAddresses() throws PeerDiscoveryException {
        DnsDiscovery.DnsSeedDiscovery dnsSeedDiscovery = new DnsDiscovery.DnsSeedDiscovery(MainNetParams.get(), "localhost");
    ...
    public void testGetPeersThrowsPeerDiscoveryExceptionForUnknownHost() throws PeerDiscoveryException {
        DnsDiscovery.DnsSeedDiscovery dnsSeedDiscovery = new DnsDiscovery.DnsSeedDiscovery(MainNetParams.get(), "unknown host");
