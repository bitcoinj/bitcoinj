...
public abstract class MessageSerializer {
     ...
     */
    public abstract MonacoinSerializer.MonacoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException, UnsupportedOperationException;

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link MonacoinSerializer#deserializeHeader}.
     */
    public abstract Message deserializePayload(MonacoinSerializer.MonacoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException, UnsupportedOperationException;
