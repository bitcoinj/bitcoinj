 ...
 */
@NullMarked
public class FinishedBlock extends Block implements BlockData, Hashed {
    private final Sha256Hash hash;

    protected FinishedBlock(long version, Sha256Hash prevHash, Sha256Hash merkleRoot, Instant time, Difficulty difficultyTarget, long nonce, List<Transaction> transactions, Sha256Hash hash) {
