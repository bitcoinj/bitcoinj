...
public class DefaultRiskAnalysisTest {
    ...
    public void analysisCantBeUsedTwice() {
        Transaction tx = new Transaction(BitcoinNetwork.MAINNET);
    ...
    public void nonFinalDependency() {
        ...
        Transaction tx1 = new Transaction(BitcoinNetwork.MAINNET);
        ...
        Transaction tx2 = new Transaction(BitcoinNetwork.MAINNET);
        tx2.addInput(output);
    ...
    public void nonStandardDust() {
        Transaction standardTx = new Transaction(BitcoinNetwork.MAINNET);
        ...
        Transaction dustTx = new Transaction(BitcoinNetwork.MAINNET);
        ...
        Transaction edgeCaseTx = new Transaction(BitcoinNetwork.MAINNET);
    ...
    public void canonicalSignatureLowS() throws Exception {
        ...
        Transaction tx1 = new Transaction(BitcoinNetwork.MAINNET, ByteBuffer.wrap(ByteUtils.parseHex(
        ...
        Transaction tx2 = new Transaction(BitcoinNetwork.MAINNET, ByteBuffer.wrap(ByteUtils.parseHex(
