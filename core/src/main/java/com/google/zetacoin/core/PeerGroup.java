...
import com.google.zetacoin.net.ClientConnectionManager;
import com.google.zetacoin.net.NioClientManager;
import com.google.zetacoin.net.discovery.PeerDiscovery;
import com.google.zetacoin.net.discovery.PeerDiscoveryException;
import com.google.zetacoin.script.Script;
import com.google.zetacoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.google.zetacoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.zetacoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.zetacoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.zetacoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.zetacoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.zetacoin.core.Peer#ping()}.
     */
