...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        // copied verbatim from https://en.monacoin.it/wiki/Protocol_specification#Network_address
        ...
        String reserialized = Utils.HEX.encode(pa.unsafeMonacoinSerialize());
        assertEquals(reserialized,fromSpec );
    }

    @Test
    public void testMonacoinSerialize() throws Exception {
        ...
        assertEquals("000000000000000000000000000000000000ffff7f000001208d",
                Utils.HEX.encode(pa.monacoinSerialize()));
    }
}
