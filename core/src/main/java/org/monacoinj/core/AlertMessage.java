 ...
 * The private keys are held by a small group of core Monacoin developers, and alerts may be broadcast in the event of
...
public class AlertMessage extends Message {
    ...
    protected void parse() throws ProtocolException {
        ...
        version = readUint32();
        // Read the timestamps. Monacoin uses seconds since the epoch.
    ...
    /**
     * The inclusive lower bound on software versions that are considered for the purposes of this alert. Monacoin Core
    ...
    /**
     * The inclusive upper bound on software versions considered for the purposes of this alert. Monacoin Core
     * compares this against a protocol version field, but as long as the subVer field is used to restrict it your
     * alerts could use any version numbers.
     */
    ...
    /**
     * A string that is intended to display in the status bar of Monacoin Core's GUI client. It contains the user-visible
