...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.bitcoincashj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.bitcoincashj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.bitcoincashj.crypto.KeyCrypter,
