...
import static org.monacoinj.core.Coin.FIFTY_COINS;
...
public abstract class AbstractFullPrunedBlockChainTest {
    ...
    public void testGetOpenTransactionOutputs() throws Exception {
        ...
        // Create monacoin spend of 1 MONA.
    ...
    public void testUTXOProviderWithWallet() throws Exception {
        ...
        // Create 1 MONA spend to a key in this wallet (to ourselves).
        ...
        // Create another spend of 1/2 the value of MONA we have available using the wallet (store coin selector).
        ...
        // The availbale balance should be the 0 (as we spent the 1 MONA that's pending) and estimated should be 1/2 - fee MONA
        assertEquals("Available balance is incorrect", Coin.ZERO, wallet.getBalance(Wallet.BalanceType.AVAILABLE));
