 ...
 * <p>
 * Concrete implementations have to implement {@link #getSignature(Sha256Hash, HDPath.HDPartialPath)}
...
public abstract class CustomTransactionSigner implements TransactionSigner {
    ...
    public boolean signInputs(ProposedTransaction propTx, KeyBag keyBag) {
        ...
        for (int i = 0; i < numInputs; i++) {
            ...
            try {
                ...
                ScriptExecution.correctlySpends(txIn.getScriptSig(), tx, i, txIn.getWitness(), txOut.getValue(), txOut.getScriptPubKey(),
    ...
    protected abstract SignatureAndKey getSignature(Sha256Hash sighash, HDPath.HDPartialPath derivationPath);
