 ...
 * <p>
 * See test class org.bitcoinj.crypto.BIP85DeterministicEntropyTest for examples on how to use this class.
 */
public class BIP85DeterministicEntropy {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(BIP85DeterministicEntropy.class);

    private BIP85DeterministicEntropy() {
    }
