...
/**
 * Network parameters used by the monacoinj unit tests (and potentially your own). This lets you solve a block using
 * {@link org.monacoinj.core.Block#solve()} by setting difficulty to the easiest possible.
 */
public class UnitTestParams extends AbstractMonacoinNetParams {
