...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 MONA", COIN.toFriendlyString());
        assertEquals("1.23 MONA", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 MONA", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 MONA", valueOf(1, 23).negate().toFriendlyString());
    }

    /**
     * Test the monacoinValueToPlainString amount formatter
     */
    @Test
