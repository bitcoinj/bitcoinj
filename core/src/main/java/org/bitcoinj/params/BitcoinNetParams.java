 ...
 */
public abstract class BitcoinNetParams extends AbstractBitcoinNetParams {
    ...
    private static final Logger log = LoggerFactory.getLogger(BitcoinNetParams.class);
     ...
     * No-args constructor
     */
    public BitcoinNetParams(BitcoinNetwork network) {
        super(network);
        interval = INTERVAL;
     ...
     */
    @Nullable
    public static BitcoinNetParams fromID(String id) {
