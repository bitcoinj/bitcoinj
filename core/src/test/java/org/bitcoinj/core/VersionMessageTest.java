...
public class VersionMessageTest {
    ...
    public void decode_noRelay_bestHeight_subVer() {
        ...
        VersionMessage ver = new VersionMessage(BitcoinNetwork.TESTNET, ByteBuffer.wrap(ByteUtils.parseHex(hex)));
    ...
    public void roundTrip_ipv4() throws Exception {
        VersionMessage ver = new VersionMessage(BitcoinNetwork.TESTNET, 1234);
        ...
        VersionMessage ver2 = new VersionMessage(BitcoinNetwork.TESTNET, ByteBuffer.wrap(serialized));
