...
// This file shows how to use bitcoincashj from Javascript.
// To run, grab the bitcoincashj bundled JAR and then do something like this:
//
//   jjs -cp bitcoincashj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp bitcoincashj-0.12-bundled.jar
//
...
//
//   jjs -cp bitcoincashj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And bitcoincashj is a threaded library. This means you
