...
package org.monacoinj.protocols.payments;
 ...
 *
 * <ul>
 * <li>A {@link MonacoinURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link org.monacoin.protocols.payments.Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link org.monacoin.protocols.payments.Protos.PaymentRequest} object</li>
 * </ul>
 *
 * <p>If initialized with a MonacoinURI or a url, a network request is made for the payment request object and a
 ...
 *
 * <p>Call sendPayment with a list of transactions that will be broadcast. A {@link org.monacoin.protocols.payments.Protos.Payment} message will be sent
 * to the merchant if a payment url is provided in the PaymentRequest. NOTE: sendPayment does NOT broadcast the
 * transactions to the monacoin network. Instead it returns a ListenableFuture that will be notified when a
 * {@link org.monacoin.protocols.payments.Protos.PaymentACK} is received from the merchant. Typically a wallet will show the message to the user
 ...
 *
 * @see <a href="https://github.com/monacoin/bips/blob/master/bip-0070.mediawiki">BIP 0070</a>
 */
public class PaymentSession {
     ...
     * uri is a BIP-72-style MonacoinURI object that specifies where the {@link org.monacoin.protocols.payments.Protos.PaymentRequest} object may
     ...
     * be verified.</p>
     */
    public static ListenableFuture<PaymentSession> createFromMonacoinUri(final MonacoinURI uri) throws PaymentProtocolException {
        return createFromMonacoinUri(uri, true, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromMonacoinUri(final MonacoinURI uri, final boolean verifyPki)
            throws PaymentProtocolException {
        return createFromMonacoinUri(uri, verifyPki, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromMonacoinUri(final MonacoinURI uri, final boolean verifyPki, @Nullable final TrustStoreLoader trustStoreLoader)
            throws PaymentProtocolException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentProtocolException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in MonacoinURI " + uri);
        try {
     ...
     * url is an address where the {@link org.monacoin.protocols.payments.Protos.PaymentRequest} object may be fetched.
     * If verifyPki is specified and the payment request object specifies a PKI method, then the system trust store will
     * be used to verify the signature provided by the payment request. An exception is thrown by the future if the
     * signature cannot be verified.
     */
    ...
    /**
     * Creates a PaymentSession from the provided {@link org.monacoin.protocols.payments.Protos.PaymentRequest}.
    ...
    /**
     * Returns the total amount of monacoins requested.
     */
     ...
     * NOTE: This does not broadcast the transactions to the monacoin network, it merely sends a Payment message to the
