...
import org.monacoin.NativeSecp256k1;
import org.monacoin.NativeSecp256k1Util;
import org.monacoin.Secp256k1Context;
import org.monacoinj.wallet.Protos;
 ...
 *
 * <p>ECKey also provides access to Monacoin Core compatible text message signing, as accessible via the UI or JSON-RPC.
 ...
 * are encoded using ASN.1/DER inside the Monacoin protocol.</p>
 *
...
public class ECKey implements EncryptableItem {
    ...
    // The parameters of the secp256k1 curve that Monacoin uses.
    ...
    /**
     * Construct an ECKey from an ASN.1 encoded private key. These are produced by OpenSSL and stored by Monacoin
    ...
    /**
     * Output this ECKey as an ASN.1 encoded private key, as understood by OpenSSL or used by Monacoin Core
     * in its wallet storage format.
     * @throws org.monacoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the Monacoin protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * href="https://github.com/monacoin/bips/blob/master/bip-0062.mediawiki#Low_S_values_in_signatures">BIP62</a>.
         */
         ...
         * the same message. However, we dislike the ability to modify the bits of a Monacoin transaction after it's
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Monacoin protocol, they are
     * usually encoded using ASN.1 format, so you want {@link org.monacoinj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Monacoin protocol, they are
     * usually encoded using DER format, so you want {@link org.monacoinj.core.ECKey.ECDSASignature#encodeToDER()}
    ...
    /**
     * Signs a text message using the standard Monacoin messaging signing format and returns the signature as a base64
     * encoded string.
     *
    ...
    /**
     * Given an arbitrary piece of text and a Monacoin-format message signature encoded in base64, returns an ECKey
     * containing the public key that was used to sign it. This can then be compared to the expected public key to
     * determine if the signature was correct. These sorts of signatures are compatible with the Monacoin-Qt/monacoind
     * format generated by signmessage/verifymessage RPCs and GUI menu options. They are intended for humans to verify
     * their communications with each other, hence the base64 format and the fact that the input is text.
     *
     * @param message Some piece of human readable text.
     * @param signatureBase64 The Monacoin-format message signature in base64
     ...
     * @throws org.monacoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
    ...
    /**
     * Exports the private key in the form used by Monacoin Core's "dumpprivkey" and "importprivkey" commands. Use
     * the {@link org.monacoinj.core.DumpedPrivateKey#toString()} method to get the string.
     *
     ...
     * monacoins controlled by the private key) you can use this method to check when you *encrypt* a wallet that
