...
public class UtilsTest {
    ...
    public void testReadInt64() {
        assertEquals(258L, Utils.readInt64(
                new byte[]{2, 1, 0, 0, 0, 0, 0, 0}, 0));
        assertEquals(258L, Utils.readInt64(
                new byte[]{2, 1, 0, 0, 0, 0, 0, 0, 3, 4}, 0));
        assertEquals(772L, Utils.readInt64(
                new byte[]{1, 2, 4, 3, 0, 0, 0, 0, 0, 0}, 2));
        assertEquals(-1L, Utils.readInt64(
    ...
    public void testReadUInt32BE() {
        assertEquals(258L, Utils.readUint32BE(
                new byte[]{0, 0, 1, 2}, 0));
        assertEquals(258L, Utils.readUint32BE(
                new byte[]{0, 0, 1, 2, 3, 4}, 0));
        assertEquals(772L, Utils.readUint32BE(
                new byte[]{1, 2, 0, 0, 3, 4}, 2));
    }
    ...
    public void testRollMockClock() {
        ...
        assertEquals(new Date("Thu Jan 01 07:00:08 GMT 1970"),
                Utils.rollMockClock(8));
    }
}
