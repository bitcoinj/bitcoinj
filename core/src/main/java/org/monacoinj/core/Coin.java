...
/**
 * Represents a monetary Monacoin value. This class is immutable.
 */
public final class Coin implements Monetary, Comparable<Coin>, Serializable {

    /**
     * Number of decimals for one Monacoin. This constant is useful for quick adapting to other coins because a lot of
     * constants derive from it.
     */
    public static final int SMALLEST_UNIT_EXPONENT = 8;

    /**
     * The number of satoshis equal to one monacoin.
     */
    ...
    /**
     * 0.01 Monacoins. This unit is not really used much.
     */
    public static final Coin CENT = COIN.divide(100);

    /**
     * 0.001 Monacoins, also known as 1 mMONA.
     */
    public static final Coin MILLICOIN = COIN.divide(1000);

    /**
     * 0.000001 Monacoins, also known as 1 µMONA or 1 uMONA.
     */
    public static final Coin MICROCOIN = MILLICOIN.divide(1000);

    /**
     * A satoshi is the smallest unit that can be transferred. 100 million of them fit into a Monacoin.
     */
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.MONA.minDecimals(2).repeatOptionalDecimals(1, 6).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.MONA.minDecimals(0).repeatOptionalDecimals(1, 8).noCode();

    /**
     * <p>
     * Returns the value as a plain string denominated in MONA.
     * The result is unformatted with no trailing zeroes.
     * For instance, a value of 150000 satoshis gives an output string of "0.0015" MONA
     * </p>
     */
