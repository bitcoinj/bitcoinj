...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.monacoinj.core.PeerFilterProvider}s, a merged
 * {@link org.monacoinj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.monacoinj.core.PeerGroup} class internally.</p>
 *
