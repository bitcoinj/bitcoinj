...
import com.google.zetacoin.net.AbstractTimeoutHandler;
import com.google.zetacoin.net.MessageWriteTarget;
import com.google.zetacoin.net.StreamParser;
 ...
 * {@link com.google.zetacoin.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.google.zetacoin.net.NioClient} or
     * {@link com.google.zetacoin.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
