...
/**
 * Various constants that define the assembly-like scripting language that forms part of the Monacoin protocol.
 * See {@link org.monacoinj.script.Script} for details. Also provides a method to convert them to a string.
 */
