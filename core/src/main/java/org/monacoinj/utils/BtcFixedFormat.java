...
import static org.monacoinj.core.Coin.SMALLEST_UNIT_EXPONENT;
 ...
 * instance formats and by-default parses all Monacoin monetary values in units of a single
...
public final class BtcFixedFormat extends BtcFormat {
     ...
     *  thet same value expressed in monacoins. */
     ...
     * the denomination is millimonacoins, this method will return the value <code>3</code>.  As
     ...
     *  the denomination is millimonacoins, this method will return the value <code>3</code>.  */
    @Override
     ...
     * denomination is millimonacoins, then this method will return <code>"mMONA"</code>,
     ...
     * millimonacoins, this method by default returns <code>"₥฿"</code>, depending on the
     * locale.  */
