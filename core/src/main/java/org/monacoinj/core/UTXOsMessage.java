/*
 * Copyright 2014 the monacoinj authors
 *
 ...
 * supported by Monacoin Core. An implementation is available in <a href="https://github.com/monacoinxt/monacoinxt">Monacoin XT</a>,
 * a patch set on top of Core. Thus if you want to use it, you must find some XT peers to connect to. This can be done
 * using a {@link org.monacoinj.net.discovery.HttpDiscovery} class combined with an HTTP/Cartographer seed.</p>
 *
 * <p>The getutxos/utxos protocol is defined in <a href="https://github.com/monacoin/bips/blob/master/bip-0065.mediawiki">BIP 65</a>.
...
public class UTXOsMessage extends Message {
    ...
    protected void monacoinSerializeToStream(OutputStream stream) throws IOException {
        ...
        for (int i = 0; i < outputs.size(); i++) {
            ...
            output.monacoinSerializeToStream(stream);
        }
    }
