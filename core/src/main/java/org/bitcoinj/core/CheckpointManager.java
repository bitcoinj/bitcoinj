...
public class CheckpointManager {
    ...
    /**
     * Warning: This may be removed in a later bitcoinj 0.18 pre-release. This really shouldn't
     * have been made public and is easily replaced. We'll leave it as deprecated in
     * any milestone/alpha releases, but will remove it when we remove Guava as a dependency.
