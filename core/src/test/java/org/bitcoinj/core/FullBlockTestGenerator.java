...
class TransactionOutPointWithValue {
    public TransactionOutPointReference outpoint;
    public Coin value;
    public Script scriptPubKey;

    public TransactionOutPointWithValue(TransactionOutPointReference outpoint, Coin value, Script scriptPubKey) {
    ...
    public TransactionOutPointWithValue(Transaction tx, int outputIndex) {
        this(TransactionOutPointReference.of(tx.getTxId(), outputIndex),
...
public class FullBlockTestGenerator {
    ...
    public RuleList getBlocksToTest(boolean runBarelyExpensiveTests, boolean runExpensiveTests, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
        ...
        spendableOutputs.offer(new TransactionOutPointWithValue(
                TransactionOutPointReference.of(chainHead.transaction(0).getTxId(), 0),
        ...
        NewBlock b39 = createNextBlock(b35, chainHeadHeight + 12, null, null);
        {
            ...
            TransactionOutPointReference lastOutPoint;
            {
                Transaction tx = new Transaction();
                ...
                lastOutPoint = TransactionOutPointReference.of(tx.getTxId(), 1);
        ...
        NewBlock b40 = createNextBlock(b39, chainHeadHeight + 13, out12, null);
        {
            ...
            TransactionOutPointReference lastOutPoint = TransactionOutPointReference.of(b40.block.transaction(1).getTxId(), 1);
            ...
            for (int i = 1; i <= numTxes; i++) {
                ...
                TransactionInput input = new TransactionInput(tx, new byte[]{},
                        TransactionOutPointReference.of(b39.block.transaction(i).getTxId(), 0));
                tx.addInput(input);
                ...
                lastOutPoint = TransactionOutPointReference.of(tx.getTxId(), 0);
        ...
        if (runBarelyExpensiveTests) {
            b41 = createNextBlock(b39, chainHeadHeight + 13, out12, null);
            {
                ...
                TransactionOutPointReference lastOutPoint = TransactionOutPointReference.of(
        ...
        Transaction b56p2txToDuplicate1, b56p2txToDuplicate2;
        {
            ...
            addOnlyInputToTransaction(tx2, new TransactionOutPointWithValue(
                    TransactionOutPointReference.of(tx1.getTxId(), 0),
            ...
            addOnlyInputToTransaction(b56p2txToDuplicate1, new TransactionOutPointWithValue(
                    TransactionOutPointReference.of(tx2.getTxId(), 0),
            ...
            addOnlyInputToTransaction(b56p2txToDuplicate2, new TransactionOutPointWithValue(
                    TransactionOutPointReference.of(b56p2txToDuplicate1.getTxId(), 0),
        ...
        NewBlock b58 = createNextBlock(b57, chainHeadHeight + 18, out17, null);
        {
            ...
            b58.getSpendableOutput().outpoint = TransactionOutPointReference.of(tx.getTxId(), 42);
        ...
        Transaction b84tx1 = new Transaction();
        {
            ...
            tx2.addOutput(new TransactionOutput(tx2, ZERO, new byte[]{OP_RETURN}));
            tx2.addInput(new TransactionInput(tx2, new byte[]{OP_TRUE}, TransactionOutPointReference.from(b84tx1, 1)));
            ...
            tx3.addInput(new TransactionInput(tx3, new byte[]{OP_TRUE}, TransactionOutPointReference.from(b84tx1, 2)));
            ...
            tx4.addInput(new TransactionInput(tx4, new byte[]{OP_TRUE}, TransactionOutPointReference.from(b84tx1, 3)));
            b84.addTransaction(tx4);

            Transaction tx5 = new Transaction();
            tx5.addOutput(new TransactionOutput(tx5, ZERO, new byte[]{OP_RETURN}));
            tx5.addInput(new TransactionInput(tx5, new byte[]{OP_TRUE}, TransactionOutPointReference.from(b84tx1, 4)));
        ...
        NewBlock b89 = createNextBlock(b88, chainHeadHeight + 33, out32, null);
        {
            ...
            tx.addInput(new TransactionInput(tx, new byte[]{OP_TRUE}, TransactionOutPointReference.from(b84tx1, 0)));
        ...
        if (runExpensiveTests) {
            ...
            TransactionOutPointReference lastOutput = TransactionOutPointReference.of(b1001.block.transaction(1).getTxId(), 1);
            ...
            for (blockCountAfter1001 = 0; blockCountAfter1001 < TRANSACTION_CREATION_BLOCKS; blockCountAfter1001++) {
                ...
                while (block.block.messageSize() < Block.MAX_BLOCK_SIZE - 500) {
                    ...
                    tx.addOutput(ZERO, OP_TRUE_SCRIPT);
                    tx.addOutput(ZERO, OP_TRUE_SCRIPT);
                    lastOutput = TransactionOutPointReference.of(tx.getTxId(), 1);
