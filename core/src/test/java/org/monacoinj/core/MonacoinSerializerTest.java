...
public class MonacoinSerializerTest {
    ...
    public void testAddr() throws Exception {
        ...
        // the actual data from https://en.monacoin.it/wiki/Protocol_specification#addr
    ...
    public void testMonacoinPacketHeaderTooShort() {
        new MonacoinSerializer.MonacoinPacketHeader(ByteBuffer.wrap(new byte[] { 0 }));
    }

    @Test(expected = ProtocolException.class)
    public void testMonacoinPacketHeaderTooLong() {
        ...
        new MonacoinSerializer.MonacoinPacketHeader(ByteBuffer.wrap(wrongMessageLength));
    }
