...
public class FullBlockTestGenerator {
    ...
    public RuleList getBlocksToTest(boolean runBarelyExpensiveTests, boolean runExpensiveTests, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
        ...
        Block b44 = new Block(params.network(), Block.BLOCK_VERSION_GENESIS);
        ...
        Block b45 = new Block(params.network(), Block.BLOCK_VERSION_GENESIS);
        {
        ...
        // A block with no txn
        Block b46 = new Block(params.network(), Block.BLOCK_VERSION_GENESIS);
        {
        ...
        {
            Transaction coinbase = new Transaction(params.network());
        ...
        {
            b56txToDuplicate = new Transaction(params.network());
        ...
        {
            Transaction tx1 = new Transaction(params.network());
            ...
            Transaction tx2 = new Transaction(params.network());
            ...
            b56p2txToDuplicate1 = new Transaction(params.network());
            ...
            b56p2txToDuplicate2 = new Transaction(params.network());
        ...
        NewBlock b67 = createNextBlock(b65, chainHeadHeight + 21, null, null);
        {
            ...
            Transaction tx3 = new Transaction(params.network());
        ...
        Transaction b78tx = new Transaction(params.network());
        {
        ...
        Transaction b79tx = new Transaction(params.network());
        ...
        Transaction b84tx1 = new Transaction(params.network());
        {
            ...
            Transaction tx4 = new Transaction(params.network());
            ...
            Transaction tx5 = new Transaction(params.network());
