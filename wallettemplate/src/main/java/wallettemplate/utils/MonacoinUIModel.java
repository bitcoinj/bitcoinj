...
import org.monacoinj.wallet.listeners.AbstractWalletEventListener;
...
/**
 * A class that exposes relevant monacoin stuff as JavaFX bindable properties.
 */
public class MonacoinUIModel {
    ...
    public MonacoinUIModel() {
    }

    public MonacoinUIModel(Wallet wallet) {
        setWallet(wallet);
    }
