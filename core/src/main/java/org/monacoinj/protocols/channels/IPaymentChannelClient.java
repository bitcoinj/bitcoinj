...
import org.monacoin.paymentchannel.Protos;
...
public interface IPaymentChannelClient {
     ...
     * {@link org.monacoinj.protocols.channels.IPaymentChannelClient.ClientConnection#destroyConnection(org.monacoinj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link org.monacoinj.protocols.channels.IPaymentChannelClient.ClientConnection#destroyConnection(org.monacoinj.protocols.channels.PaymentChannelCloseException.CloseReason)}
     ...
     * be accepted by the Monacoin network. ValueOutOfRangeException will be thrown, however, if there's not enough money
    ...
    interface ClientConnection {
         ...
         * {@link org.monacoinj.protocols.channels.PaymentChannelClient#connectionClosed()} should be called immediately. In the case of messages which
         ...
         *
         * <p>Called while holding a lock on the {@link org.monacoinj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         */
         ...
         * {@link org.monacoinj.protocols.channels.PaymentChannelClient#connectionClosed()} event should be generated immediately after this call.</p>
         *
         * <p>Called while holding a lock on the {@link org.monacoinj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         *
         ...
         *               {@link org.monacoinj.protocols.channels.PaymentChannelCloseException.CloseReason#CLIENT_REQUESTED_CLOSE} as "unrecoverable error" and all others as
         ...
         * will be closed with a  {@link org.monacoinj.protocols.channels.PaymentChannelCloseException.CloseReason#TIME_WINDOW_UNACCEPTABLE}.</p>
         ...
         * {@link org.monacoinj.protocols.channels.PaymentChannelClient#incrementPayment(Coin)}
         * may be called at will.</p>
         *
         * <p>Called while holding a lock on the {@link org.monacoinj.protocols.channels.PaymentChannelClient}
    ...
    interface ClientChannelProperties {
         ...
         *  See {@link org.monacoinj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
         *
         */
        long timeWindow();
