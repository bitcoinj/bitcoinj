...
import org.bitcoincash.NativeSecp256k1;
import org.bitcoincash.NativeSecp256k1Util;
import org.bitcoincash.Secp256k1Context;
...
public class ECKey implements EncryptableItem {
     ...
     * usually encoded using ASN.1 format, so you want {@link org.bitcoincashj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link org.bitcoincashj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * the {@link org.bitcoincashj.core.DumpedPrivateKey#toString()} method to get the string.
     *
