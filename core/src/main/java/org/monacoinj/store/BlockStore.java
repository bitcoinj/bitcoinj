 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the Monacoin serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link org.monacoinj.core.BlockChain#getChainHead()}
     * or perhaps {@link org.monacoinj.core.BlockChain#getBestChainHeight()} which will run in constant time and
    ...
    /**
     * Get the {@link org.monacoinj.core.NetworkParameters} of this store.
