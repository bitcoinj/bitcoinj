...
public class TransactionTest {
    ...
    public void witnessTransaction() {
        ...
        tx = new Transaction(NetworkParameters.of(BitcoinNetwork.MAINNET), Payload.ofHex(hex));
    ...
    public void testWitnessSignatureP2WPKH() {
        ...
        String txHex = "01000000" // version
                ...
                + "11000000"; // nLockTime
        Transaction tx = new Transaction(TESTNET, Payload.ofHex(txHex));
    ...
    public void testCoinbaseHeightCheck() {
        ...
        final Payload transactionBytes = Payload.ofHex(
    ...
    public void parseTransactionWithHugeDeclaredInputsSize() {
        ...
        try {
            new Transaction(TESTNET, Payload.of(serializedTx));
    ...
    public void nonSegwitZeroInputZeroOutputTx() {
        ...
        Transaction tx = TESTNET.getDefaultSerializer().makeTransaction(Payload.ofHex(txHex));
        assertEquals(txHex, tx.toHexString());
    }
    ...
    public void nonSegwitZeroInputOneOutputTx() {
        ...
        tx = serializer.withProtocolVersion(protoVersionNoWitness).makeTransaction(Payload.ofHex(txHex));
        assertEquals(txHex, tx.toHexString());
    }
}
