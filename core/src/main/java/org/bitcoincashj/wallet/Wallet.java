...
import org.bitcoincashj.core.AbstractBlockChain;
...
import org.bitcoincashj.core.FilteredBlock;
...
import org.bitcoincashj.core.PeerFilterProvider;
...
import org.bitcoincashj.core.TransactionBag;
import org.bitcoincashj.core.TransactionBroadcast;
...
import org.bitcoincashj.core.UTXO;
import org.bitcoincashj.core.UTXOProvider;
import org.bitcoincashj.core.UTXOProviderException;
...
import org.bitcoincashj.signers.*;
import org.bitcoincashj.utils.*;
import org.bitcoincashj.wallet.Protos.Wallet.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bitcoincashj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.bitcoincashj.wallet.KeyChain.KeyPurpose)} with
    ...
    /**
     * Returns address for a {@link #currentKey(org.bitcoincashj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.bitcoincashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.bitcoincashj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.bitcoincashj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.bitcoincashj.wallet.KeyChain.KeyPurpose)}
     */
     ...
     * key, after loading a wallet produced by previous versions of bitcoincashj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bitcoincashj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.bitcoincashj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.bitcoincashj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.bitcoincashj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.bitcoincashj.crypto.KeyCrypter,
     ...
     * {@link org.bitcoincashj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.bitcoincashj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.bitcoincashj.utils.Threading#waitForUserCode()} to block until the future had a
