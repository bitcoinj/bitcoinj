...
public class ECKey implements EncryptableItem {
    ...
    private String toString(boolean includePrivate, @Nullable AesKey aesKey, Network network) {
        ...
        return new ToStringUtil(this)
                ...
                .addIf(privHex != null, "priv HEX", privHex)
                .addIf(privWif != null, "priv WIF", privWif)
                .addIf(creationTimeSeconds > 0, "creationTime=" + creationTimeSeconds)
                .addIf(keyCrypter != null, "keyCrypter=" + keyCrypter)
                .addIf(encryptedPrivKeyStr != null, "encryptedPrivateKey=" + encryptedPrivKeyStr)
