...
public class ECKeyTest {
    ...
    @Test
    public void base58Encoding_mainnet() throws Exception {
        String addr = "GSS5vVwdAXUwUdsZYVhfQCC5guJn3Mgo1k";
        String privkey = "Kx2nhwei3NHRtdPShaXoywB8mT1LZPVZiAf6NpBV9kdebusz9dRZ";
        ECKey key = DumpedPrivateKey.fromBase58(MAINNET, privkey).getKey();
        assertEquals(privkey, key.getPrivateKeyEncoded(MAINNET).toString());
        assertEquals(addr, LegacyAddress.fromKey(MAINNET, key).toString());
    }
    ...
    public void verifyMessage() throws Exception {
        ...
        Address expectedAddress = LegacyAddress.fromBase58(MAINNET, "GMPJrVif5E3prxGBK7Y5jDFpxzhx4z9KSM");
