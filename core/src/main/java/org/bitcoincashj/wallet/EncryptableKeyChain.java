...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.bitcoincashj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.bitcoincashj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.bitcoincashj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
