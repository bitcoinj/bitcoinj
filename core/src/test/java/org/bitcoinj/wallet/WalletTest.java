...
public class WalletTest extends TestWithWallet {
    ...
    public void isWatching() {
        ...
        Wallet watchingWallet = Wallet.fromWatchingKey(TESTNET,
                wallet.getWatchingKey().dropPrivateBytes().withoutParent(), ScriptType.P2PKH);
    ...
    public void completeTxPartiallySignedThrows() throws Exception {
        ...
        Wallet watching = Wallet.fromWatchingKey(TESTNET, wallet.getWatchingKey().withoutParent().dropPrivateBytes(),
                ScriptType.P2PKH);
    ...
    public void deprecatedMembers() {
        ...
        DeterministicKeyChain keyChain = DeterministicKeyChain.builder()
                ...
                .build();
        DeterministicKey watchingKey = keyChain.getWatchingKey().dropPrivateBytes().withoutParent();
