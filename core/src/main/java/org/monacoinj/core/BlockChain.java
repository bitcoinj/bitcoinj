...
/**
 * A BlockChain implements the <i>simplified payment verification</i> mode of the Monacoin protocol. It is the right
...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.monacoinj.store.SPVBlockStore} or you could also try a
     * {@link org.monacoinj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
