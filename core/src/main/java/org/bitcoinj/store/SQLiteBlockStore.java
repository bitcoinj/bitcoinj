...
class SQLiteBlockStore implements BlockStore {
    ...
    Connection conn;
    public SQLiteBlockStore(NetworkParameters params, String filename) {
    ...
    public synchronized final void put(StoredBlock block) throws BlockStoreException {
        ...
        try {
            ...
            addBlock.setBigDecimal(2, new BigDecimal(block.getChainWork()));
    ...
    public synchronized StoredBlock get(Sha256Hash hash) throws BlockStoreException {
        ...
        try {
            ...
            if (result.next()){
                ...
                block = new StoredBlock(blockHeader, result.getBigDecimal(2).toBigInteger(), result.getInt(3));
            } else {
