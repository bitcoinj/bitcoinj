...
public class TransactionOutPoint extends ChildMessage {
    ...
    // This is not part of monacoin serialization. It points to the connected transaction.
    Transaction fromTx;
     ...
     * For P2SH scripts you can use {@link #getConnectedRedeemData(org.monacoinj.wallet.KeyBag)} and then get the
     * key from RedeemData.
