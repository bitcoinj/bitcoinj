...
public class BitcoinSerializer extends MessageSerializer {
    ...
    private Message makeMessage(String command, byte[] payloadBytes, byte[] hash) throws ProtocolException {
        Payload payload = Payload.of(payloadBytes);
     ...
     */
    @Override
    public AddressV1Message makeAddressV1Message(Payload payload) throws ProtocolException {
     ...
     */
    @Override
    public AddressV2Message makeAddressV2Message(Payload payload) throws ProtocolException {
     ...
     */
    @Override
    public Block makeBlock(Payload payload) throws ProtocolException {
     ...
     */
    @Override
    public InventoryMessage makeInventoryMessage(Payload payload) throws ProtocolException {
     ...
     */
    @Override
    public Transaction makeTransaction(Payload payload, byte[] hashFromHeader)
            throws ProtocolException {
        return new Transaction(params, payload, null, this, hashFromHeader);
    }
