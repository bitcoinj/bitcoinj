...
import org.monacoinj.utils.BtcAutoFormat.Style;
import static org.monacoinj.utils.BtcAutoFormat.Style.*;
 ...
 * representations of Monacoin monetary values.
 *
 ...
 * represents a Monacoin monetary value.  Some of the features offered for doing this
 * are: <ol>
 ...
 * String c = f.format(Coin.COIN);                <strong>// "MONA 1.00"</strong>
 * String k = f.format(Coin.COIN.multiply(1000)); <strong>// "MONA 1,000.00"</strong>
 * String m = f.format(Coin.COIN.divide(1000));   <strong>// "mMONA 1.00"</strong>
 ...
 * code, such as <code>"MONA"</code>, to indicate the units of denomination, while the
 * <code>SYMBOL</code> style uses a possibly-ambiguous currency symbol such as
 * <code>"฿"</code>.
 *
 * <p>The denomination used when formatting will be either monacoin, millicoin
 ...
 * locale, a value of one monacoin might be formatted as <pre>฿1.00</pre> where a value
 ...
 * increasing precision to convert the representation of a given quantity of monacoins into a
 * representation of the same value denominated in the formatter's units.  For example, a scale
 * value of <code>3</code> specifies a denomination of millimonacoins, because to represent
 * <code>1.0000 MONA</code>, or one monacoin, in millimonacoins, one shifts the decimal point
 * three places, that is, to <code>1000.0 mMONA</code>.
 *
 * <h3>Construction</h3>
 *
 ...
 * <blockquote><pre>
 * BtcFormat f = BtcFormat.getInstance();
 * String s = f.format(Coin.COIN); <strong>// "MONA 1.00"</strong>
 * </pre></blockquote>
 *
 ...
 * values in units of micromonacoins:
 *
 ...
 * differently the same one-monacoin value:
 *
 * <blockquote><pre>
 * <strong>// Next line returns "1,00 MONA"</strong>
 ...
 * <h3>Formatting</h3>
 *
 * <p>You format a Monacoin monetary value by passing it to the {@link BtcFormat#format(Object)}
 * method.  This argument can be either a {@link org.monacoinj.core.Coin}-type object or a
 ...
 * number of monacoins.  A value having a fractional amount of satoshis is rounded to the
 ...
 * <strong>// next line formats the value as "987.654.321,23 µMONA"</strong>
 * String output = de.format(valueOf(98765432123L), new StringBuffer(), currField);
 * <strong>// next line sets variable currencyCode to "µMONA"</strong>
 ...
 * <strong>// variable coded will be set to "kMONA 1.23"</strong>
 ...
 * <code>µMONA</code> or other appropriate permutations of those characters.  Additionally, if
 ...
 * instance will infer a denomination of monacoins while a {@link BtcFixedFormat} will infer the
...
public abstract class BtcFormat extends Format {
    ...
    /** The conventional international currency code for monacoins: "MONA" */
    private static final String COIN_CODE = "MONA";
    /** The default currency symbols for monacoins */
    ...
    /* Scale is the number of decimal-places difference from same value in monacoins */
    /** A constant useful for specifying a denomination of monacoins, the <code>int</code> value
     *  <code>0</code>. */
    public static final int COIN_SCALE = 0;

    /** A constant useful for specifying a denomination of millimonacoins, the <code>int</code>
     *  value <code>3</code>. */
    public static final int MILLICOIN_SCALE = 3;

    /** A constant useful for specifying a denomination of micromonacoins, the <code>int</code>
     *  value <code>6</code>. */
    ...
    public static class Builder {
         ...
         *  denominated in monacoins.  For example, a denomination of millimonacoins is specified
         ...
         * fixed-denomination of monacoins, equivalent to invoking this method with an argument
         * of <code>0</code>. */
     ...
     * currency code, for example "<code>MONA</code>", to indicate that denomination.  The
    ...
    /**
     * Return a new auto-denominating instance that will indicate units using a currency
     * code, for example, <code>"MONA"</code>.  Formatting and parsing will be done
     * according to the default locale.
     */
     ...
     * <code>"MONA"</code>.  The returned object will format the fraction-part of numbers using
     * the given number of decimal places, or fewer as necessary to avoid giving a place to
     * fractional satoshis.  Formatting and parsing will be done according to the default
     * locale.
     */
     ...
     * units using a currency code, for example, <code>"mMONA"</code>.
     */
     ...
     * <code>"mMONA"</code>.  The returned object will format the fraction-part of numbers using
     * the given number of decimal places, or fewer as necessary to avoid giving a place to
     * fractional satoshis.
     */
     ...
     * <code>"฿"</code>, or code, such as <code>"mMONA"</code>, depending on the value of
     ...
     * <code>"mMONA"</code>, depending on the value of the first argument.  The returned object
     ...
     * "<code>MONA</code>", or symbol, such as "<code>฿</code>", depending on the value
     ...
     * such as <code>"mMONA"</code>, or symbol, such as "<code>฿</code>",
     ...
     * values in terms of monacoins, with the given minimum number of fractional
    ...
    /**
     * Formats a monacoin monetary value and returns an {@link java.text.AttributedCharacterIterator}.
    ...
    /**
     * Formats a monacoin value as a number and possibly a units indicator and appends the
     ...
     * number of monacoins, rounded to the nearest satoshi as necessary.
     *
    ...
    /**
     * Formats a monacoin value as a number and possibly a units indicator to a
     ...
     * <code>BigDecimal</code> is interpreted as that number of monacoins, rounded to the
     ...
     * is the size of the decimal-place shift between the given Monacoin-value denominated in
     * monacoins and that same value as formatted.  A fixed-denomination formatter will ignore
     * the arguments.
     *
    ...
    /**
     * Takes a monacoin monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a monacoin quantity of any type the
	...
	BigInteger satoshis;
        // the value might be monacoins or satoshis
    ...
    /**
      * Parse a <code>String</code> representation of a Monacoin monetary value.  Returns a
      * {@link org.monacoinj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
    ...
    /** Parse a <code>String</code> representation of a Monacoin monetary value.  If this
     ...
     * String, then the number is interpreted as a quatity of monacoins.
     * <p>If the pattern contains neither a currency symbol nor sign, then instances of {@link
     * BtcAutoFormat} will interpret the parsed number as a quantity of monacoins, and instances
    ...
    /** Return the unprefixed currency symbol for monacoins configured for this object.  The
    ...
    /** Return the unprefixed international currency code for monacoins configured for this
