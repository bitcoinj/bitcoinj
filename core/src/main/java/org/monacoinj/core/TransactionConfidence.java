...
import org.monacoinj.core.listeners.BlockChainListener;
 ...
 *
 * <p>TransactionConfidence is updated via the {@link org.monacoinj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link org.monacoinj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link org.monacoinj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link org.monacoinj.core.TransactionConfidence#getConfidenceType()}
     ...
     * On average there is supposed to be a new block every 10 minutes, but the actual rate may vary. Monacoin Core
     ...
     * and so on. This information is useful for {@link org.monacoinj.wallet.CoinSelector} implementations to risk analyze
