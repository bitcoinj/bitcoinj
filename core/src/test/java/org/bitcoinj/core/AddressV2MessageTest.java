...
public class AddressV2MessageTest {
    ...
    public void roundtrip() {
        ...
        assertEquals("2009-01-09T02:54:25Z", TimeUtils.dateTimeFormat(a0.getTimeInstant().get()));
        ...
        assertEquals("2039-11-22T11:22:33Z", TimeUtils.dateTimeFormat(a1.getTimeInstant().get()));
        ...
        assertEquals("2106-02-07T06:28:15Z", TimeUtils.dateTimeFormat(a2.getTimeInstant().get()));
        ...
        assertEquals("1970-01-01T00:00:00Z", TimeUtils.dateTimeFormat(a3.getTimeInstant().get()));
        ...
        assertEquals("1970-01-01T00:00:00Z", TimeUtils.dateTimeFormat(a4.getTimeInstant().get()));
