...
/**
 * <p>Methods to serialize and de-serialize messages to the Monacoin network format as defined in
 * <a href="https://en.monacoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.monacoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class MonacoinSerializer extends MessageSerializer {
    private static final Logger log = LoggerFactory.getLogger(MonacoinSerializer.class);
    ...
    /**
     * Constructs a MonacoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     * @param parseRetain      retain the backing byte array of a message for fast reserialization.
     */
    public MonacoinSerializer(NetworkParameters params, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("MonacoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.monacoinSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Monacoin protocol message has the following format.
        //
        ...
        //
        // Monacoin Core ignores garbage before the magic header bytes. We have to do the same because
        // sometimes it sends us stuff that isn't part of any message.
        seekPastMagicBytes(in);
        MonacoinPacketHeader header = new MonacoinPacketHeader(in);
     ...
     */
    @Override
    public MonacoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new MonacoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link MonacoinSerializer#deserializeHeader}.
     */
    @Override
    public Message deserializePayload(MonacoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class MonacoinPacketHeader {
        ...
        public MonacoinPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
