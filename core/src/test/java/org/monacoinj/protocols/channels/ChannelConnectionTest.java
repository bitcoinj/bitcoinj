...
import org.monacoinj.protocols.channels.PaymentChannelClient.VersionSelector;
...
import org.monacoinj.wallet.WalletFiles;
...
import static org.monacoinj.protocols.channels.PaymentChannelClient.VersionSelector.*;
import static org.monacoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.monacoinj.testing.FakeTxBuilder.createFakeBlock;
import static org.monacoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.monacoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
